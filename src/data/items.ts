...
export const ITEMS: readonly ItemDef[] = [
  { id: 'apple', name: 'Яблоко', emoji: '🍎', rarity: 1, basePrice: 8, modifiers: { maxHp: 3 } },
  ...
  { id: 'bandage', name: 'Бинт', emoji: '🩹', rarity: 3, basePrice: 26, weight: 0.45, modifiers: { hpRegen: 0.8 } },
  ...
  { id: 'steak', name: 'Стейк', emoji: '🥩', rarity: 3, basePrice: 30, modifiers: { maxHp: 7, moveSpeed: -6 } },
  ...
  { id: 'heart', name: 'Сердце титана', emoji: '💖', rarity: 4, basePrice: 60, weight: 0.5, modifiers: { maxHp: 13, hpRegen: 1.5 } },
